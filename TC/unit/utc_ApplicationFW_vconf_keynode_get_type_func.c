...
static void utc_ApplicationFW_vconf_keynode_get_type_func_01(void);
static void utc_ApplicationFW_vconf_keynode_get_type_func_02(void);
...
struct tet_testlist tet_testlist[] = {
	{ utc_ApplicationFW_vconf_keynode_get_type_func_01, POSITIVE_TC_IDX },
	{ utc_ApplicationFW_vconf_keynode_get_type_func_02, NEGATIVE_TC_IDX },
	{ NULL, 0 }
};
...
/**
 * @brief Positive test case of vconf_keylist_get_type()
 */
static void utc_ApplicationFW_vconf_keynode_get_type_func_01(void)
{
	int r = 0;	
	...
	{
		if(vconf_keynode_get_type(pKeyNode) == -1)
		{
...
/**
 * @brief Negative test case of ug_init vconf_keylist_get_type()
 */
static void utc_ApplicationFW_vconf_keynode_get_type_func_02(void)
{
	int r = vconf_keynode_get_type(NULL);
	if (r!=-1) {
