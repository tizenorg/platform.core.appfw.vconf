...
static void utc_ApplicationFW_vconf_keynode_get_bool_func_01(void);
static void utc_ApplicationFW_vconf_keynode_get_bool_func_02(void);
static void utc_ApplicationFW_vconf_keynode_get_bool_func_03(void);
...
struct tet_testlist tet_testlist[] = {
	{ utc_ApplicationFW_vconf_keynode_get_bool_func_01, POSITIVE_TC_IDX },
	{ utc_ApplicationFW_vconf_keynode_get_bool_func_02, NEGATIVE_TC_IDX },
	{ utc_ApplicationFW_vconf_keynode_get_bool_func_03, NEGATIVE_TC_IDX },
	{ NULL, 0 }
};
...
/**
 * @brief Positive test case of vconf_keynode_get_bool()
 */
static void utc_ApplicationFW_vconf_keynode_get_bool_func_01(void)
{
	int r = 0;	
	...
	while((pKeyNode = vconf_keylist_nextnode(pKeyList))!=NULL)
	{
		switch(vconf_keynode_get_type(pKeyNode))
		{
			case VCONF_TYPE_BOOL:
				nResult = vconf_keynode_get_bool(pKeyNode);
				if (nResult != KEY_01_BOOL_VALUE) {
...
/**
 * @brief Negative test case of ug_init vconf_keynode_get_bool()
 */
static void utc_ApplicationFW_vconf_keynode_get_bool_func_02(void)
{
	int r = 0;	

	r = vconf_keynode_get_bool(NULL);
	if (r!=-1) {
		tet_infoline("vconf_keynode_get_bool() func_02 failed in negative test case");
		tet_result(TET_FAIL);
		return;
	}
...
static void utc_ApplicationFW_vconf_keynode_get_bool_func_03(void)
{
	...
	while((pKeyNode = vconf_keylist_nextnode(pKeyList))!=NULL)
	{
		...
		{
			case VCONF_TYPE_INT:
				r = vconf_keynode_get_bool(pKeyNode);
				if (r!=-1) {
					tet_infoline("vconf_keynode_get_bool() func_03 failed in negative test case");
					tet_result(TET_FAIL);
					return;
				}
				break;
