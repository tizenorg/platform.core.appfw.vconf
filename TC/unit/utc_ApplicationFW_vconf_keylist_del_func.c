...
static void utc_ApplicationFW_vconf_keylist_del_func_01(void);
static void utc_ApplicationFW_vconf_keylist_del_func_02(void);
static void utc_ApplicationFW_vconf_keylist_del_func_03(void);
...
struct tet_testlist tet_testlist[] = {
	{ utc_ApplicationFW_vconf_keylist_del_func_01, POSITIVE_TC_IDX },
	{ utc_ApplicationFW_vconf_keylist_del_func_02, NEGATIVE_TC_IDX },
	{ utc_ApplicationFW_vconf_keylist_del_func_03, NEGATIVE_TC_IDX },
	{ NULL, 0 }
};
...
/**
 * @brief Positive test case of vconf_keylist_del()
 */
static void utc_ApplicationFW_vconf_keylist_del_func_01(void)
{
	int r = 0;	
	...
	if(vconf_keylist_del(pKeyList, KEY_03)<0)
	{
		tet_infoline("vconf_get() failed in positive test case");
		tet_result(TET_FAIL);
		return;
	...
	while((pKeyNode = vconf_keylist_nextnode(pKeyList))!=NULL)
	{
		...
		if(!strncmp(pszKeyName, KEY_03, strlen(pszKeyName)))
		{
			tet_infoline("vconf_get() failed in positive test case");
			tet_result(TET_FAIL);
			return;
...
static void utc_ApplicationFW_vconf_keylist_del_func_02(void)
{
	if(vconf_keylist_del(NULL, KEY_03)>=0)
	{
		tet_infoline("vconf_keylist_del() failed in negative test case");
		tet_result(TET_FAIL);
		return;
	}
...
static void utc_ApplicationFW_vconf_keylist_del_func_03(void)
{
	...
	if(vconf_keylist_del(pKeyList, NULL)>=0)
	{
		tet_infoline("vconf_keylist_del() failed in negative test case");
		tet_result(TET_FAIL);
		return;
